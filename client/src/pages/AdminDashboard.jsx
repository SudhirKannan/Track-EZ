...
const BusManagement = () => (
  <div className="p-6">
    <h2 className="text-2xl font-bold text-gray-900 mb-6">Bus Management</h2>
    <div className="bg-white rounded-lg shadow p-6">
      <p className="text-gray-600">Bus management features coming soon...</p>
    </div>
  </div>
);
...
const AdminDashboard = () => {
  ...
  const navigation = [
    ...
    { name: 'Bus Management', href: '/admin/buses', icon: Bus, current: location.pathname === '/admin/buses' },
    { name: 'User Management', href: '/admin/users', icon: Users, current: location.pathname === '/admin/users' },
    { name: 'Live Tracking', href: '/admin/tracking', icon: MapPin, current: location.pathname === '/admin/tracking' },
  ];
